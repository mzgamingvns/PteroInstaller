...
if [ -d "/var/www/pterodactyl" ]; then
  ...
  case $action in
    1)
      ...
      bash <(curl -s https://raw.githubusercontent.com/mzgamingvns/PteroInstaller/Production/modes/uninstall.sh)
...
if [ "$basic" == false ] && [ "$standard" == false ]; then
  ...
  [ "$panel" == true ] && bash <(curl -s https://raw.githubusercontent.com/mzgamingvns/PteroInstaller/Production/modes/panel.sh)
  [ "$wings" == true ] && bash <(curl -s https://raw.githubusercontent.com/mzgamingvns/PteroInstaller/Production/modes/wings.sh)
elif [ "$standard" == true ]; then
  bash <(curl -s https://raw.githubusercontent.com/mzgamingvns/PteroInstaller/Production/modes/standard.sh)
else
  bash <(curl -s https://raw.githubusercontent.com/mzgamingvns/PteroInstaller/Production/modes/basic.sh)
fi
