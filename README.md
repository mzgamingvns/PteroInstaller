...
```
bash <(curl -Ss https://raw.githubusercontent.com/mzgamingvns/PteroInstaller/Production/install.sh || wget -O - https://raw.githubusercontent.com/mzgamingvns/PteroInstaller/Production/install.sh) auto
```
...
4. [Neon](https://github.com/DeveloperNeon)
5. [sam1370](https://github.com/sam1370)
6. [Linux123123](https://github.com/Linux123123)
